...
Maps the excel-parser pipeline to the 11-stage Excellent algorithm (0-10)
...
from excel_parser.models.common import BlockType, CellAnnotation, StableModel
from excel_parser.models.table_structure import TableStructure
from excel_parser.models.template import TemplateNode
...
class StageVerifier:
    """
    Verifies excel-parser output against the Excellent Algorithm stages.
