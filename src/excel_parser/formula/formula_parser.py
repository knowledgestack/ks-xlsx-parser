...
# Optional Rust fast-path: excel_core.scan_formula returns reference tuples
...
# regex passes per formula. See rust/excel_core/src/formula.rs.
try:
    from excel_core import scan_formula as _rust_scan_formula  # type: ignore[import-not-found]
