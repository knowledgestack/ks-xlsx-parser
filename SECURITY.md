...
Instead, report them via GitHub's [Private Vulnerability Reporting](https://github.com/knowledgestack/excel-parser/security/advisories/new)
...
excel-parser processes untrusted `.xlsx` input, so we treat the following as
in-scope:
